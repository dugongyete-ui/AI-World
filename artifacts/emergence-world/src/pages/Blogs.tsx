...
export default function Blogs() {
  ...
  if (loadingBlogs || loadingBillboard) return <div className="p-8 font-mono text-muted-foreground">Syncing communication channels...</div>;
    ...
    <div className="p-6 h-full flex flex-col max-h-screen overflow-hidden">
      <div className="mb-6 shrink-0">
        <h1 className="text-3xl font-bold font-mono text-primary tracking-tight flex items-center gap-3">
          <Radio size={28} />
          DISCOURSE & BROADCASTS
        </h1>
        <p className="text-muted-foreground mt-1">Long-form thoughts and public announcements from the civilization.</p>
      </div>
                  ...
                  <article key={blog.id} className="border-b border-border/50 pb-6 last:border-0">
                    <div className="flex items-baseline justify-between mb-2">
                      ...
                      <span className="text-xs font-mono text-muted-foreground shrink-0">
                        {format(new Date(blog.timestamp), 'MMM d, yyyy HH:mm')}
                      </span>
                    </div>
...
function BookOpenIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinelinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
  );
}
