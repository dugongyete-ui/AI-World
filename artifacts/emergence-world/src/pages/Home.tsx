...
import { Activity, Clock, MapPin, Terminal } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="flex h-full w-full flex-col lg:flex-row">
      ...
      <div className="flex-1 relative flex flex-col min-h-[50vh]">
        ...
        <div className="absolute top-4 right-4 z-10 bg-black/50 backdrop-blur-md p-3 rounded-lg border border-white/10 font-mono text-xs text-white/80 flex flex-col gap-1">
          ...
          <div className="flex justify-between gap-4">
            ...
            <span>{worldState?.weather.condition.toUpperCase() || 'UNKNOWN'}</span>
          </div>
          <div className="flex justify-between gap-4">
        ...
        <div className="h-48 border-t border-border bg-card/80 backdrop-blur-md flex flex-col">
          <div className="px-4 py-2 border-b border-border flex items-center gap-2">
            ...
            <span className="text-xs font-mono font-semibold text-primary">SYSTEM LOG</span>
          </div>
      ...
      {/* Right Sidebar - Active Agent Info */}
        ...
        {activeAgent ? (
          <div className="p-4 flex flex-col gap-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-xs text-muted-foreground font-mono mb-1 block">LOCATION</label>
              ...
              <div>
                <label className="text-xs text-muted-foreground font-mono mb-1 block">LAST ACTION</label>
                <div className="text-sm bg-muted/50 p-3 rounded border border-border/50 font-mono text-primary-foreground/90">
                  {activeAgent.lastAction || "Idle"}
                </div>
              </div>

              {activeAgent.lastSpeech && (
                <div>
                  <label className="text-xs text-muted-foreground font-mono mb-1 block">VOCALIZATION</label>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-muted/30 p-2 rounded">
                  <label className="text-[10px] text-muted-foreground uppercase block mb-1">Energy</label>
                ...
                <div className="bg-muted/30 p-2 rounded">
                  <label className="text-[10px] text-muted-foreground uppercase block mb-1">Credits</label>
